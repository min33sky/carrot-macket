...
const Home: NextPage = () => {
  return (
    <div className="grid min-h-screen gap-10 px-20 py-20 bg-slate-400">
      <div className="p-6 bg-white shadow-xl dark:text-white dark:bg-black sm:hover:bg-pink-800 sm:bg-red-400 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-400 2xl:bg-pink-500 rounded-3xl">
